...
const PutToDB = (Posts, setPosts, updatedPost) => {
  putMethod(Posts, setPosts, updatedPost);
};
    ...
    >
      ...
      <div class="w-96 mt-10 bg-gray-400" style={{ width: "90%", marginLeft: "5%" }}>
        <div class="relative w-full min-w-[200px]">
          <button
            id="UpdateButton"
            onClick={() => PutToDB(Posts, setPosts, getPostFromInput())}
...
export function getPostFromInput() {
  return {
    ...
    postTitle: document.getElementById("titlebox").value,
